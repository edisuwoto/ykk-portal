        ...
        @if ($readyToLoad)
            <div x-show="section === 0"
                ...
                <div>
                    ...
                    <x-input type="email" wire:model.defer="form.email" disabled class="text-xs w-full"/>
        ...
        <div class="w-full flex items-center justify-between">
            ...
            <div>
                <x-button wire:click="submit" wire:loading.attr="disabled">
                    <i wire:loading wire:target="submit" class="fas fa-spin fa-circle-notch"></i> {{ __('button.update') }}
                </x-button>
            </div>
        </div>
    </x-modal.footer>
